...
@section('content')
    ...
    <div class="card col-md-12">
        <div class="card-header">
            ...
            <div class="card-body">
                <div>
                    <a href="/add-course" class="btn btn-danger ml-5 mb-3">
                         Lisa uus eriala
                    </a>
                </div>
                ...
                <button style="margin-bottom: 10px" class="btn btn-warning delete_all" data-url="{{ url('deleteAll-course') }}">Kustuta kõik</button>
