...
@section('content')
    <div class="card col-md-12">
        <div class="card-header">
            <h4 class="card-title">LISA PRAKTIKAJUHENDAJA</h4>
            <div class="card-body p-4">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="input-group">
                                <div class="input-group-prepend m-0">
                                               <span class="input-group-text" style="border: 1px solid #888888;" id="basic-addon1">
                                                   <i class="fas fa-table fa-sm" style="color: #E60011;"></i>
                                               </span>
                                </div>
                            <select name="practice-instructor_id" class="form-control label-control">
                                <option value="practice-instructor_id" aria-labelledby="dropdownMenuButton"></option>

                                <option value="practice-instructor_id">Praktikajuhendaja</option>
                            </select>
                        </div>
                    </div>
                        <div class="form-group">
                ...
                <!--Dropdown for base->unit->dep-->
                    <div class="row col-md-12">
                        <label for="" class="mr-1 mt-2">Lisa seos praktikabaasiga</label>
        ...
        $(document).ready(function(){
            ...
            $('.dynamic').change(function(){
                if($(this).val() != '')
                {
                    ...
                    $.ajax({
                        url: "{{ route('addunitdeptobase2.fetch') }}",
                        method:"POST",
